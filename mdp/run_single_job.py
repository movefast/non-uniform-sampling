...
agent_infos = {
    ...
    "GEO_sim": {"step_size": 3e-3, "buffer_size": 1000, "batch_size": 10, "correction":True, "geo_alpha":0.6, "buffer_beta":0.4, "beta_increment":1e-4, "recency_bias": True, "grad_norm": False,"tau": 0.01, "min_weight":.01, "num_meta_update":1, "weighting_strat":2},
